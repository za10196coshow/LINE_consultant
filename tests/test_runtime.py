...
def test_render_has_conversation_assistant_defaults():
    ...
    assert env["CONVERSATION_NEED_CONFIDENCE_THRESHOLD"] == "0.6"
    assert env["CONVERSATION_EXPECTED_HELPFULNESS_THRESHOLD"] == "0.7"
    assert env["CONVERSATION_INTRUSIVENESS_RISK_MAX"] == "0.45"
    assert env["CONVERSATION_INTERVENTION_SCORE_THRESHOLD"] == "0.25"
